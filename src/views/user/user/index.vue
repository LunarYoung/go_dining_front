  ...
  <div>
    <el-card class="container-card" shadow="always">
      ...
      <el-table v-loading="loading" :data="tableData" border stripe style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column show-overflow-tooltip sortable prop="status" label="微信uid" />
        <el-table-column show-overflow-tooltip sortable prop="name" label="名称" />
        <el-table-column show-overflow-tooltip sortable prop="name" label="地址" />
        <!--        <el-table-column show-overflow-tooltip sortable prop="introduction" label="图片" >-->
        <!--          <el-avatar shape="square" :size="100" :fit="fit" :src="url"></el-avatar>-->
        <!--        </el-table-column>-->

        <el-table-column show-overflow-tooltip sortable prop="nickname" label="电话" />
