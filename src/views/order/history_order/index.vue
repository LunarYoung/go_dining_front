  ...
  <div>
    <el-card class="container-card" shadow="always">
      ...
      <el-table v-loading="loading" :data="tableData" border stripe style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column show-overflow-tooltip sortable prop="nickname" label="用户名" />
        <el-table-column show-overflow-tooltip sortable prop="status" label="电话" />
        <el-table-column show-overflow-tooltip sortable prop="status" label="地址" align="center" />
        <el-table-column show-overflow-tooltip sortable prop="status" label="备注" align="center" />

        <el-table-column show-overflow-tooltip sortable prop="mobile" label="菜名" />
        <el-table-column show-overflow-tooltip sortable prop="creator" label="金额" />
